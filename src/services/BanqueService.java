...
public interface BanqueService {
     ...
     * 
     * @return
     *     returns services.BanqueService_Type
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getBanqueServicePort", targetNamespace = "http://services/", className = "services.GetBanqueServicePort")
    @ResponseWrapper(localName = "getBanqueServicePortResponse", targetNamespace = "http://services/", className = "services.GetBanqueServicePortResponse")
    @Action(input = "http://services/BanqueService/getBanqueServicePortRequest", output = "http://services/BanqueService/getBanqueServicePortResponse")
